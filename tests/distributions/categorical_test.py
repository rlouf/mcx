...
out_of_support_cases = [
    {"probs": jnp.array([0.1, 0.2, 0.7]), "x": -1, "expected": -jnp.inf},
    {"probs": jnp.array([0.1, 0.2, 0.7]), "x": 3, "expected": -jnp.inf},
    {"probs": jnp.array([0.1, 0.2, 0.7]), "x": 3.5, "expected": -jnp.inf},
]
...
edge_cases = [
    {"probs": jnp.array([1]), "x": 0, "expected": 0.0},
    {"probs": jnp.array([0, 1]), "x": 1, "expected": 0},
    {"probs": jnp.array([0, 1]), "x": 0, "expected": -jnp.inf},
]
...
logpdf_shapes = [
    {"x": 0, "probs": jnp.array([0.4, 0.1, 0.5]), "expected_shape": ()},
    {"x": 1, "probs": jnp.array([[0.1, 0.9], [0.2, 0.8]]), "expected_shape": (2,)},
]
